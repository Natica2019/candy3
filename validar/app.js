...
if(document.getElementById('btnRegistro')){
    ...
    btnRegistro.addEventListener('click',(e)=>{
        ...
        Fnacimiento=formRegistro.nombre.value.trim();
        Cedula=formRegistro.nombre.value.trim();
        ...
        if(nombre=="" && Fnacimiento=="" &&Cedula=="" && correo=="" && password==""){
            ...
            inputError([formRegistro.nombre,formRegistro.Fnacimiento,formRegistro.Cedula,formRegistro.correo,formRegistro.password]);
            return false;

        }else{
            //removemos esa clase con la siguente funcion
            inputErrorRemove([formRegistro.nombre,formRegistro.Fnacimiento,formRegistro.Cedula,formRegistro.correo,formRegistro.password]);
        }
